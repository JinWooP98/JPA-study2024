    ...
    void practice1Test() {
        ...
        List<Tuple> result = factory
                ...
                .where(idol.age.gt(
                                ...
                                .and(idol.gender.eq(targetGender))
                )
                .fetch();
        ...
        assertFalse(result.isEmpty());
        for (Tuple i : result) {
            String idolName = i.get(idol.idolName);
            int idolAge = i.get(idol.age);
            System.out.printf("\n# 아이돌 이름: %s, 나이: %d\n", idolName, idolAge);
        }
    }

//    @Test
//    @DisplayName("문제 2. 2023년도에 발매된 앨범이 없는 그룹 조회")
//    void practice2Test() {
//        //given
//        int year = 2023;
//        //when
